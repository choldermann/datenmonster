          ...
          {JOIN_TYPES.map((jt) => (
            <button key={jt.value} onClick={() => onChange({ ...join, join_type: jt.value })}
              style={{
                ...
                backgroundColor: join.join_type === jt.value ? JOIN_COLOR + "22" : S.bgEl,
                border: `1px solid ${join.join_type === jt.value ? JOIN_COLOR : S.border}`,
                color: join.join_type === jt.value ? JOIN_COLOR : S.textDim,
